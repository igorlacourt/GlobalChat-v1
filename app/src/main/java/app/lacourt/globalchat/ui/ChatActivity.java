...
import app.lacourt.globalchat.adapters.MessagesAdapter;
import app.lacourt.globalchat.model.Chat;
import app.lacourt.globalchat.model.Message;
import app.lacourt.globalchat.utils.ConnectivityHelper;
import app.lacourt.globalchat.viewmodel.ChatViewModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void createMessage() {
        ...
        newMessageMap.put("text", messageBodyEditText.getText().toString());//messageBodyEditText.getText().toString().isEmpty());
...
//            Intent data = new Intent();
//            data.putExtra(getString(R.string.NEW_CHAT_CREATED), newChatCreated);
//            setResult(getResources().getInteger(R.integer.CHAT_RESULT), data);
//            finish();
        }
...
//        Intent data = new Intent();
//        data.putExtra(getString(R.string.NEW_CHAT_CREATED), newChatCreated);
//        setResult(RESULT_OK , new Intent().putExtra(getString(R.string.NEW_CHAT_CREATED), true));
//        finish();
    }

...
//                            .setMessage("Insert the verification code you received.")
...
//                    startActivityForResult(intent, getResources().getInteger(R.integer.VERIFICATION_RESULT));
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                if(completePhoneNum.equals(getString(R.string.test1))){
                    showInsertCodeDialog();
                }
            }
...
//            Toast.makeText(LoginActivity.this, "Insert a country code.", Toast.LENGTH_LONG).show();
//
//        } else
